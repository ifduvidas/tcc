...
class CrudPerguntas
{
    ...
    {
        $sql = "SELECT p.id_pergunta,p.descricao_pergunta, p.titulo, p.status from perguntas as p, aluno_comenta as c where c.id_pergunta = p.id_pergunta GROUP by c.id_pergunta ORDER by COUNT(c.id_comentario) desc";
        $resultado = $this->conexao->query($sql);
